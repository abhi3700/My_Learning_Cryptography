...
- Some more protocols in zk-SNARK are:
  - Libra
  - Sonic
  - SuperSonic
  - PlonK
...
- A language called [Circom](https://github.com/iden3/circom) which helps in writing the cryptographic circuits behind zk-SNARKs. In other words, create provable programs, a.k.a programs with computational proofs.
